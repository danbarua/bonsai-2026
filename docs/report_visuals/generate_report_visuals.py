...
def plot8_concentration_landscape():
    ...
    ax.set_title("Concentration is a single sharp cell, not a gradient\n"
                 "(mean top1 across sign/amplitude/replica -- both already shown to have no effect)",
                 fontsize=10)
    fig.tight_layout()
...
def plot9_destination_consistency_map():
    ...
    fig.suptitle("Destination consistency: which node wins, per trajectory and condition\n"
