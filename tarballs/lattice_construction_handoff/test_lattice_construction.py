...
from lattice_construction import build_lattice_topology
...
RAW_TOPOLOGIES = Path(__file__).parent / "kmnist_class_topologies_200.pkl"
HISTORICAL_ARTIFACT = Path(__file__).parent / "stage1a_all_classes.pkl"
