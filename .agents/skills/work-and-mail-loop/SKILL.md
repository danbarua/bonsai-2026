...
- A destination requires HUMAN RELAY: Codex-desktop and ChatGPT
  ...
  addressed mesh message to Codex-desktop-orchestrator), then SAY SO
...
One line per iteration, appended to `.Codex/logs/work-and-mail-loop/<your-session-name>.log`
